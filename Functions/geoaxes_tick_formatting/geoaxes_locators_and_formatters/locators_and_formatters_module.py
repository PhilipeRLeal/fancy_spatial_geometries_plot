...
class LongitudeFormatter(_PlateCarreeFormatter):
    ...
    def __init__(self,
                 ...
                 seconds_number_format='g',
                 auto_hide=True,
                 west_hemisphere_str='W', east_hemisphere_str='E'
...
if __name__ == '__main__':
    ...
    left, bottom, width, height = [0.1, 0.18, 0.8, 0.3]
    
    ax1 = plt.axes((left, bottom, width, height), projection=ccrs.PlateCarree(central_longitude=180))
    ax1.set_global()
    ax1.coastlines()
    ...
    left, bottom, width, height = [0.1, 0.65, 0.8, 0.3]
    
    ax2 = plt.axes( (left, bottom, width, height), projection=ccrs.Mercator())
    ax2.set_global()
    ax2.coastlines()
    ...
    SHP.plot(ax=ax2, categorical=True, column='CD_GEOCMU', legend=False, transform =projection)
    
    
    
    SHP.plot(ax=ax1, categorical=True, column='CD_GEOCMU', legend=False, transform =projection)
